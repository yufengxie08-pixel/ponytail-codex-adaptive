...
// Codex gets a compact core at session start; its prompt hook routes each task
// to a profile. Other hosts retain the original full session ruleset.
let output = isCodex
  ? getCodexPonytailInstructions(mode, { profile: 'core', cwd: process.cwd() })
